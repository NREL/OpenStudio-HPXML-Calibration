...
class Calibrate:
    def __init__(
        ...
        default_ga_config = {
            ...
            "value_choices": {
                "misc_load_multiplier_choices": [round(x * 0.1, 1) for x in range(-9, 11)]
                + [5, 10],
                "air_leakage_multiplier_choices": [round(x * 0.1, 1) for x in range(-5, 11)] + [2],
                "hvac_eff_multiplier_choices": [round(x * 0.1, 2) for x in range(-2, 13)],
                "roof_r_value_multiplier_choices": [round(x * 0.1, 2) for x in range(-2, 13)],
                "ceiling_r_value_multiplier_choices": [round(x * 0.1, 2) for x in range(-2, 13)],
                ...
                "slab_r_value_multiplier_choices": [round(x * 0.1, 2) for x in range(-2, 13)],
                "floor_r_value_multiplier_choices": [round(x * 0.1, 2) for x in range(-2, 13)],
                ...
                "water_fixtures_usage_multiplier_choices": [
                    round(x * 0.1, 1) for x in range(-9, 11)
                ]
                + [5, 10],
                "window_u_factor_multiplier_choices": [round(x * 0.1, 2) for x in range(-2, 13)],
                "window_shgc_multiplier_choices": [round(x * 0.1, 2) for x in range(-2, 13)],
                "appliance_usage_multiplier_choices": [round(x * 0.1, 1) for x in range(-9, 11)]
                + [5, 10],
                "lighting_load_multiplier_choices": [round(x * 0.1, 1) for x in range(-9, 11)]
                + [5, 10],
            },
        }
